...
my $RefSeqInfo = `grep -P "$RefSeq\t" "/media/Bastiaan_Portable/Work/Active Projects/iKRUNC/software/RefSeq/refGene.txt"`;
...
`cat "/media/Bastiaan_Portable/Work/Active\ Projects/iKRUNC/software/scripts/svgcreator/header" > $OutputFile`;
...
`cat "/media/Bastiaan_Portable/Work/Active\ Projects/iKRUNC/software/scripts/svgcreator/footer" >> $OutputFile`;
