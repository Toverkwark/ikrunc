...
open (IN,'/media/Data/iKRUNC/mm10/refGene.txt') or die "Could not open refGene file\n";
...
open (OUT,,">",'/media/Data/iKRUNC/mm10/refGene.unique.txt') or die "Could not open outputfile\n";
