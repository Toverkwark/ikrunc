...
my $gRNALength		= 20;	# Length of gRNA target sequences
...
my $DistanceCalculator	= "/media/Bastiaan_Portable/Work/Active Projects/iKRUNC/software/scripts/deepseq/barcodedistance";    # Location of the file containing C distance calculations (Hamming and Damerau-Levenshtein)
